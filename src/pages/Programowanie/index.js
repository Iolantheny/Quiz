...
import startIcon from '../../assets/img/start-violet.png';
...
const Programowanie = () => {
    ...
    return (
        <div className='main-wrapper_prog'>
                ...
                <div>
                    ...
                    {Over && userAnswers.length !== QuestionsData.length  ? (
                        <div>
                            ...
                            <div className='main-header-wrapper_icon'><img src={progIcon} alt='icon' /></div>
                            <hr />
                            <p className='main-header-wrapper_name'>PROGRAMOWANIE</p>

                            <div className='button-start-prog'>
                    ...
                    {!Over && QuestionsData[number].type === "select" && (
                        <div className="main-question-wrapper">
                            <div className="main-question-wrapper__type">
                                ...
                                <div className="question-nr-wrapper-prog"><p> {number + 1} / {QuestionsData.length} </p></div>
                            </div>
                            ...
                            <div className={`main-question-wrapper__answer`}>
                                {answers.map((answer, index) => (
                                    <div key={index}>
                                        <button value={answer} onClick={CheckAnswer} disabled={canAnswer} className="prog answerResult">
                                                ...
                                                <div className={`main-question-wrapper__answer`}>
                                                    {answers.map((answer, index) => (
                                                        <Draggable key={answer} draggableId={answer} index={index}>
                                                            {(provided) => {
                                                                return (
                                                                    <div className="drag-drop-answers-prog" {...provided.draggableProps} ref={provided.innerRef} {...provided.dragHandleProps}>
            ...
            {Over && userAnswers.length === QuestionsData.length  ? (
                <div className="main-end-wrapper">
                    <div className="main-end-wrapper__score">
                        <div className='main-end-wrapper_icon'><img src={progIcon} alt='icon' /></div>
                        <hr />
                        <p className='main-header-wrapper_name'>PROGRAMOWANIE</p>
                        <div className="score-wrapper">
                            <p className="background">TWÓJ WYNIK</p>
                            <div className="question-nr-wrapper-prog"><p>{score}/{QuestionsData.length}</p></div>
                        </div>
                        <div className='button-restart-prog'>
                    ...
                    <div className="main-end-category">
                        ...
                        <div className='nav-end-wrapper'>
                            <div className="end-category-wrapper-prog"><Link to="/Technologia" style={{ textDecoration: 'none' }}><CategoryButton name={'TECHNOLOGIA'} img={techIcon} /></Link></div>
                            <div className='end-category-wrapper-prog'><Link to="/Kultura" style={{ textDecoration: 'none' }}><CategoryButton name={"KULTURA"} img={kulturaIcon} /></Link></div>
                            <div className='end-category-wrapper-prog'><Link to="/Motoryzacja" style={{ textDecoration: 'none' }}><CategoryButton name={"MOTORYZACJA"} img={motoIcon} /></Link></div>
                            <div className='end-category-wrapper-prog'><Link to="/Historia" style={{ textDecoration: 'none' }}><CategoryButton name={"HISTORIA"} img={historiaIcon} /></Link></div>
                        </div>
                    </div>
                </div>
            ) : null}
