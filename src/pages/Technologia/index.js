...
const Technologia = () => {
    ...
    return (
        <div className='main-wrapper_tech'>
                ...
                <div>
                    ...
                    {Over && userAnswers.length !== QuestionsData.length  ? (
                        <div>
                            ...
                            <div className='main-header-wrapper_icon'><img src={techIcon} alt='icon' /></div>
                            <hr />
                            <p className='main-header-wrapper_name'>TECHNOLOGIA</p>

                            <div className='button-start-tech'>
                    ...
                    {!Over && QuestionsData[number].type === "select" && (
                        <div className="main-question-wrapper">
                            <div className="main-question-wrapper__type">
                                ...
                                <div className="question-nr-wrapper-tech"> <p>{number + 1} / {QuestionsData.length} </p></div>
                            </div>
                            ...
                            <div className={`main-question-wrapper__answer`}>
                                {answers.map((answer, index) => (
                                    <div key={index}>
                                        <button value={answer} onClick={CheckAnswer} disabled={canAnswer} className="tech answerResult">
                                                ...
                                                <div className={`main-question-wrapper__answer`}>
                                                    {answers.map((answer, index) => (
                                                        <Draggable key={answer} draggableId={answer} index={index}>
                                                            {(provided) => {
                                                                return (
                                                                    <div className="drag-drop-answers-tech" {...provided.draggableProps} ref={provided.innerRef} {...provided.dragHandleProps}>
                ...
                <div className="main-end-wrapper">
                    <div className="main-end-wrapper__score">
                        ...
                        <div className="score-wrapper">
                            ...
                            <div className="question-nr-wrapper-tech"><p>{score}/{QuestionsData.length}</p></div>
                        </div>
                        <div className='button-restart-tech'>
                    ...
                    <div className="main-end-category">
                        ...
                        <div className='nav-end-wrapper'>
                            <div className='end-category-wrapper-tech'><Link to="/Kultura" style={{ textDecoration: 'none' }}><CategoryButton name={"KULTURA"} img={kulturaIcon} /></Link></div>
                            <div className='end-category-wrapper-tech'><Link to="/Motoryzacja" style={{ textDecoration: 'none' }}><CategoryButton name={"MOTORYZACJA"} img={motoIcon} /></Link></div>
                            <div className='end-category-wrapper-tech'><Link to="/Programowanie" style={{ textDecoration: 'none' }}><CategoryButton name={"PROGRAMOWANIE"} img={progIcon} /></Link></div>
                            <div className='end-category-wrapper-tech'><Link to="/Historia" style={{ textDecoration: 'none' }}><CategoryButton name={"HISTORIA"} img={historiaIcon} /></Link></div>
                        </div>
                    </div>
                </div>
            ) : null}
