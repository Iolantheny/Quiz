...
import startIcon from '../../assets/img/button_strzałka_plus.svg';
...
const Motoryzacja = () => {
    ...
    return (
        <div className='main-wrapper_moto'>
            ...
            <div className="main-header-wrapper">
                <div>
                    ...
                    {Over && userAnswers.length !== QuestionsData.length  ? (
                        <div>
                            <p className='main-header-wrapper_category background'>WYBRANA KATEGORIA:</p>
                            <div className='main-header-wrapper_icon'><img src={motoIcon} alt='icon' /></div>
                            <hr />
                            <p className='main-header-wrapper_name'>MOTORYZACJA</p>

                            <div className='button-start-moto'>
                    ...
                    {!Over && QuestionsData[number].type === "select" && (
                        <div className="main-question-wrapper">
                            <div className="main-question-wrapper__type">
                                <div><p className="background">SELECT THE CORRECT ANSWER</p></div>
                                <div className="question-nr-wrapper-moto"><p> {number + 1} / {QuestionsData.length} </p></div>
                            </div>
                            ...
                            <div className={`main-question-wrapper__answer`}>
                                {answers.map((answer, index) => (
                                    <div key={index}>
                                        <button value={answer} onClick={CheckAnswer} disabled={canAnswer} className="moto answerResult">
                    ...
                    {!Over && QuestionsData[number].type === "DragDrop" && (
                        <div className="main-question-wrapper">
                            <div className="main-question-wrapper__type">
                                <div><p className="background">DRAG AND DROP THE CORRECT ANSWER</p></div>
                                <div className="question-nr-wrapper-moto"><p>{number + 1} / {QuestionsData.length} </p> </div>
                            </div>
                                                ...
                                                <div className={`main-question-wrapper__answer`}>
                                                    {answers.map((answer, index) => (
                                                        <Draggable key={answer} draggableId={answer} index={index}>
                                                            {(provided) => {
                                                                return (
                                                                    <div className="drag-drop-answers-moto" {...provided.draggableProps} ref={provided.innerRef} {...provided.dragHandleProps}>
            ...
            {Over && userAnswers.length === QuestionsData.length  ? (
                <div className="main-end-wrapper">
                    <div className="main-end-wrapper__score">
                        <div className='main-end-wrapper_icon'><img src={motoIcon} alt='icon' /></div>
                        <hr />
                        <p className='main-header-wrapper_name'>MOTORYZACJA</p>
                        <div className="score-wrapper">
                            <p className="background">TWÓJ WYNIK</p>
                            <div className="question-nr-wrapper-moto"><p>{score}/{QuestionsData.length}</p></div>
                        </div>
                        <div className='button-restart-moto'>
                    ...
                    <div className="main-end-category">
                        ...
                        <div className='nav-end-wrapper'>
                            <div className="end-category-wrapper-moto"><Link to="/Technologia" style={{ textDecoration: 'none' }}><CategoryButton name={'TECHNOLOGIA'} img={techIcon} /></Link></div>
                            <div className='end-category-wrapper-moto'><Link to="/Kultura" style={{ textDecoration: 'none' }}><CategoryButton name={"KULTURA"} img={kulturaIcon} /></Link></div>
                            <div className='end-category-wrapper-moto'><Link to="/Programowanie" style={{ textDecoration: 'none' }}><CategoryButton name={"PROGRAMOWANIE"} img={progIcon} /></Link></div>
                            <div className='end-category-wrapper-moto'><Link to="/Historia" style={{ textDecoration: 'none' }}><CategoryButton name={"HISTORIA"} img={historiaIcon} /></Link></div>
                        </div>
                    </div>
                </div>
            ) : null}
